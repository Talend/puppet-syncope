class syncope (
  ...
  $amq_security_switch        = $syncope::params::amq_security_switch,
  $ams_security_edition       = $syncope::params::ams_security_edition,
  ...
  $ipaas_crypto_url           = $syncope::params::ipaas_crypto_url,
